...
public sealed record UyaMpMobySummary(uint Pointer, ushort OClass, bool IsDynamic);
        ...
        if (staticCount > 0)
        {
            ...
            for (var i = 0; i < staticCount; i++)
            {
                ...
                mobys.Add(new UyaMpMobySummary(
                    ...
                    OClass: BitConverter.ToUInt16(staticBytes, offset + OClassOffset),
                    IsDynamic: false));
            }
        }
        ...
        if (dynamicCapacity > 0)
        {
            ...
            for (var i = 0; i < dynamicCapacity; i++)
            {
                ...
                mobys.Add(new UyaMpMobySummary(
                    ...
                    OClass: BitConverter.ToUInt16(dynamicBytes, offset + OClassOffset),
                    IsDynamic: true));
            }
        }
